...
export default function Kontensystem() {
  ...
  // Der Kopf steht schon im ausgelieferten HTML: So sieht eine Vorschau, eine
  // Suchmaschine und ein langsames Netz etwas Sinnvolles statt nur "Lädt".
  const kopf = (
  ...
  if (!bereit)
    return (
      <div className="mx-auto max-w-6xl px-5 py-12">
        {kopf}
        <p className="text-tinte3">Lädt …</p>
      </div>
    );
    ...
    <div className="mx-auto max-w-6xl px-5 py-12">
      ...
      <div className="kein-druck mt-10 flex flex-wrap items-center gap-3 rounded-xl border border-linie bg-flaeche p-5">
        ...
        <Sicherheitsknopf
          ...
          bestaetigung="Ja, zurücksetzen"
          onBestaetigt={() => {
            setDaten(vorlageKontensystem());
      ...
      {meldung && (
        <p role="status" className="kein-druck mt-3 text-sm text-tinte2">
          {meldung}
        </p>
      )}
    </div>
